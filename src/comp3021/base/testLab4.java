...
public class testLab4 {
	public static void main(String args[]) throws Exception{
		...
		//t.exportTextToFile("C:\\Users\\Ryan\\Desktop");
		t.exportTextToFile("");
		if(new File(((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTitle().replaceAll(" ", "_")+".txt").exists()){
		//if(new File("C:\\Users\\Ryan\\Desktop"+File.separator+((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTitle().replaceAll(" ", "_")+".txt").exists()){
